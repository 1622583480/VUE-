  ...
  <div id="app">
    ...
    <div class="control">
      <button
        ...
        :style="{ backgroundColor:styleColor2,cursor:cur2 }"
        @click="left"
      >&lt;</button>
      <button
        class="right control-btn"
        :style="{ backgroundColor:styleColor,cursor:cur }"
        @click="right"
      >&gt;</button>
    </div>
    <!-- 列表2的内容部分 -->
...
export default {
  ...
  methods: {
    ...
    changeTodo() {
      ...
      if (
        this.checkAll.length ==
        this.dataArr.length - this.num(this.dataArr)
      ) {
        this.allCheck = true;
      } else {
        this.allCheck = false;
    ...
    changeTodo2() {
      ...
      if (
        this.checkAll2.length ==
        this.changeArr.length - this.num(this.changeArr)
      ) {
        this.allCheck2 = true;
      } else {
        this.allCheck2 = false;
